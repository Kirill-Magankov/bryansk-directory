...
async def answer_types_places(callback: CallbackQuery):
    ...
    await callback.message.edit_text(
        ...
        parse_mode="HTML",
        reply_markup=pagination_kb_types(places_count, 1, type_filter, first_place['id'])
    )
...
async def page(callback: CallbackQuery):
    ...
    await callback.message.edit_text(
        ...
        parse_mode="HTML",
        reply_markup=pagination_kb_types(places_count, page, type_filter, next_place['id'])
    )
